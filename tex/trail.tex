...
are described in the notes in Table \ref{table:courses}. For courses G and S, the time limit was derived by
...
this sample, we find the median $\widetilde{\mathcal{E}}$.
...
and $C_g$ based on eleveation gain (black circles), and the hybrid ``recreational'' model
$C_r$ (gray circles). Each point is a cross-ratio of a single runner's
