...
\begin{equation}\label{eq:gain-only}
  ...
  \end{cases}
\end{equation}
whose graph is shaped like a hockey stick.
...
\subsection{Comparison of models for the effect of hills}\label{subsec:hills}
...
\section{Model of endurance}\label{sec:endurance}
