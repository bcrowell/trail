...
to make the computations degrade gracefully in cases where the limitations of the data
...
\centering
\caption{The cost of running as a function of slope, Eq \ref{eq:minetti-fit}.}
\label{fig:my-times}
\end{figure}
