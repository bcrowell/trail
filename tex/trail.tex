...
2.~Times up to 5:00 used.
3.~Times up to 1:11 used.
}
...
in half-marathon race P.
The gray dots are the author's personal-record times
from a mixture of road and trail courses, and a mixture of races and running against the clock.
...
Setting $d_c$ to half-marathon distance gives a good fit to the data.
...
only 55 and was probing small errors. We therefore need to know enough about the relevant probability distributions to
